...
class EDITOR:
  ...
  def __init__(self,root):
    self.root = root
    self.root.title("CUSTOM GUI EDITOR")
    ...
    self.status.set("Clean")
    self.menubar = Menu(self.root,font=("Arial",15,"bold"),activebackground="purple")
    self.root.config(menu=self.menubar)
    self.filemenu = Menu(self.menubar,font=("Arial",12,"bold"),activebackground="purple",tearoff=0)
    ...
    self.editmenu = Menu(self.menubar,font=("Arial",12,"bold"),activebackground="purple",tearoff=0)
    ...
    self.helpmenu = Menu(self.menubar,font=("Arial",12,"bold"),activebackground="purple",tearoff=0)
  ...
  def infoabout(self):
    messagebox.showinfo("About: "," Call me bby")
